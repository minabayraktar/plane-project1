...
var plane = Aviatrix(authorName: "Mina")

print("Welcome to the Aviatrix Flight System by \(plane.author)_________")
plane.start()

print("You're currently in \(plane.location)_________")
...
print(" ")
print("Thanks for flying with Mina Bayraktar airlines!")
